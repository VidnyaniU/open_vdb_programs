                                                 ...
                                                 const vector<tuple<int, int, double>> &B, int rowsB, int colsB)
{
    ...
    for (const auto &[rowA, colA, valueA] : A)
    {
        ...
        {
            if (colA == rowB)
            { // Check for matching indices for matrix multiplication
